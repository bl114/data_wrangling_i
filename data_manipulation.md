...
``` r
select(litters_df, variable_one = group, variable_two = litter_number)
```
...
``` r
rename(litters_df, variable_one = group, variable_two = litter_number)
```

    ## # A tibble: 49 x 8
    ##    variable_one variable_two  gd0_weight gd18_weight gd_of_birth pups_born_alive
...
```
    ...
    ##  3 Mod7  #106                21.7        37.8          20               5
    ##  4 Low7  #84/2               24.3        40.8          20               8
    ##  5 Low7  #107                22.6        42.4          20               9
    ##  6 Low7  #85/2               22.2        38.5          20               8
    ##  7 Low7  #98                 23.8        43.8          20               9
    ##  8 Low7  #102                22.6        43.3          20              11
    ##  9 Low7  #101                23.8        42.7          20               9
    ## 10 Low7  #111                25.5        44.6          20               3
    ## 11 Mod8  #97                 24.5        42.8          20               8
    ## 12 Mod8  #7/82-3-2           26.9        43.2          20               7
    ## 13 Mod8  #2/95/2             28.5        44.5          20               9
    ## 14 Mod8  #82/4               33.4        52.7          20               8
    ## 15 Low8  #53                 21.8        37.2          20               8
    ## 16 Low8  #100                20          39.2          20               8
    ## 17 Low8  #4/84               21.8        35.2          20               4
    ## 18 Low8  #108                25.6        47.5          20               8
    ## 19 Low8  #99                 23.5        39            20               6
    ## 20 Low8  #110                25.5        42.7          20               7
    ## # … with 2 more variables: pups_dead_birth <dbl>, pups_survive <dbl>
